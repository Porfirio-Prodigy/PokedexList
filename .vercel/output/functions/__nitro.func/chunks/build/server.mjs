import { hasInjectionContext, getCurrentInstance, defineComponent, h, inject, computed, unref, shallowRef, provide, shallowReactive, ref, Suspense, Fragment, createApp, toRef, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, mergeProps, getCurrentScope, nextTick, useSSRContext } from 'vue';
import { e as createError$1, h as hasProtocol, i as isScriptProtocol, k as joinURL, w as withQuery, s as sanitizeStatusCode, l as getContext, $ as $fetch, m as createHooks, n as executeAsync, o as toRouteMatcher, q as createRouter$1, r as defu } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-C7y3aXS3.mjs')
  },
  {
    name: "pokemon-search",
    path: "/pokemon/search",
    component: () => import('./index-DXmw02lW.mjs')
  },
  {
    name: "pokemon-types-type",
    path: "/pokemon/types/:type()",
    component: () => import('./_type_-JhQt-Wkp.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-qBW2dpzQ.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BDXKTK9A.mjs'));
...
export { _export_sfc as _, useNuxtApp as a, useRuntimeConfig as b, nuxtLinkDefaults as c, asyncDataDefaults as d, entry$1 as default, createError as e, fetchDefaults as f, navigateTo as n, resolveRouteObject as r, tryUseNuxtApp as t, useRouter as u };
