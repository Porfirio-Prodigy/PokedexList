...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "6793c830-6639-47cf-91e1-412590530d4a",
...
const _lazy_k_qjdu = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_k_qjdu, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_k_qjdu, lazy: true, middleware: false, method: undefined }
];
